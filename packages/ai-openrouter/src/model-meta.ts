...
const INCLUSIONAI_LING_3_0_TINY_FREE = {
...
export type OpenRouterModelOptionsByName = {
  ...
  [INCLUSIONAI_LING_3_0_FLASH.id]: OpenRouterCommonOptions &
    Pick<
      ...
      | 'topP'
    >
  [INCLUSIONAI_LING_3_0_TINY_FREE.id]: OpenRouterCommonOptions &
    Pick<
      OpenRouterBaseOptions,
      | 'frequencyPenalty'
      | 'logprobs'
...
export type OpenRouterModelInputModalitiesByName = {
  ...
  [INCLUSIONAI_LING_3_0_TINY_FREE.id]: ReadonlyArray<'text'>
  ...
  [MOONSHOTAI_KIMI_K3.id]: ReadonlyArray<'text' | 'image'>
...
export const OPENROUTER_CHAT_MODELS = [
  ...
  INCLUSIONAI_LING_3_0_TINY_FREE.id,
